...
public class FactoryManager implements Runnable , ChangeListener{
	...
	private FactoryClientListener fcListener = null;
	...
	public void setListener(FactoryClientListener fcListener)
	{
	...
	public void finishItem(String productName)
	{
		fcListener.sendMessage(productName);
	}
