...
public class BackgroundPanel extends JPanel
{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 3743187732953824853L;
	...
	public static void main(String[] args)
	{
		...
		try {
			frame.add(new BackgroundPanel(ImageIO.read(new URL("http://www-scf.usc.edu/~csci201/csci201-summer2015/labs/robot.png"))));
		} catch (IOException e) {
