...
public class FactoryTaskBoard extends FactoryObject{
	...
	//Lock for working with the table
	Lock mLock;
	
	//Line for accessing the table
	Queue<FactoryWorker> mWorkerQueue;
	Lock mQueueLock;
	...
	// Take time for the worker to look over all tasks before selecting one
	public void inspectTasks() throws InterruptedException {
