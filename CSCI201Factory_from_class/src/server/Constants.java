...
public class Constants {
	...
	public static final String clientCountString = "Client Count";
	public static final String invalidNumberErrorString = "Not a valid number";
	public static final String invalidNumberString = "Invalid number";
	public static final int maxNumClients = 100;
