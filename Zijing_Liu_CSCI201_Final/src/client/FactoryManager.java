...
public class FactoryManager implements Runnable , ChangeListener{
	...
	private FactoryClientListener mClientListener;
	...
	public void loadFactory(Factory inFactory, JTable inTable, FactoryClientListener listener) {
		...
		stop();
		mFactorySimulation = new FactorySimulation(mFactory, mTable, mClientListener);
	...
	public void reset() {
		loadFactory(mFactory,mTable, mClientListener);
	}
